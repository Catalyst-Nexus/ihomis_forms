...
function PdfCanvasPreview({
  ...
  // Resize observer for normal (non-fullscreen) mode
  // In fullscreen, container is fixed-size so we measure once after mount
  useEffect(() => {
    if (!containerRef.current || fullscreen) return undefined;
  ...
  // Measure container once after fullscreen mounts (fixed-size canvas)
  useEffect(() => {
    if (!fullscreen) return undefined;
    ...
    // Small delay ensures DOM dimensions are settled after overlay animation
      ...
      {fullscreen ? (
        <div className="lab-fs-body">
          {showPreloader ? (
            ...
            <div className="lab-fs-canvas-wrap" ref={containerRef} style={{ overflowY: "auto" }}>
