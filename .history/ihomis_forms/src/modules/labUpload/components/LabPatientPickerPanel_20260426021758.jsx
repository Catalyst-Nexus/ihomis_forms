          ...
          <div className="pk-card-context">
            {contextParams.enccode && (
              <span className="pk-context-chip">
                ...
                <span className="pk-context-value">
                  {contextParams.enccode}
                </span>
              </span>
            )}
      ...
      <div className="pk-header">
        ...
        <div className="pk-header-text">
          ...
          <p className="pk-header-sub">
            Choose whose laboratory result you are uploading. Selected IDs will
            be applied to context loading and upload requests.
          </p>
        </div>
        {hasSelection && (
          <div className="pk-header-selection">
            <span className="pk-selection-dot" aria-hidden="true" />1 selected
          </div>
        )}
      </div>
