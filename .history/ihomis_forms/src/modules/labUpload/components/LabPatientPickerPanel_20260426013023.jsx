    ...
    <section className="lab-panel pk-panel" aria-label="Patient selection">
      ...
      <div className="pk-header">
        ...
        <div className="pk-header-text">
          ...
          <p>Choose whose laboratory result you are uploading.</p>
        </div>
      </div>
      ...
      <div className="pk-search-wrap">
        <div className="pk-search-inner">
          ...
          >
            <path
              fillRule="evenodd"
              d="M8 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8zM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8z"
              clipRule="evenodd"
            />
            <path
              fillRule="evenodd"
              d="M11.5 11.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"
            />
          </svg>
          <input
            id="patientSearch"
