...
function LabUploadModule() {
    ...
    try {
      ...
      if (response.uploadedPdfUrl) {
        ...
        setStatus({
          type: "success",
          message:
            "PDF uploaded successfully. Showing the uploaded copy below.",
        });
      } else {
        setStatus({
          type: "success",
  ...
  return (
    <div className="lab-page">
      ...
      {isReviewFullscreen && activePreviewUrl ? (
        <div
        ...
        >
          ...
          <iframe
            title="Laboratory PDF full screen preview"
            src={activePreviewUrl}
            className="lab-fullscreen-frame"
          />
        </div>
      ) : null}
    </div>
