...
EncounterCard.propTypes = {
  encounter: PropTypes.shape({
    enccode: PropTypes.string.isRequired,
    encdates: PropTypes.string,
    toa: PropTypes.string,
    tod: PropTypes.string,
    patfirst: PropTypes.string,
    patmiddle: PropTypes.string,
...
EncounterSelectionModal.propTypes = {
  ...
  selectedEncounter: PropTypes.shape({
    enccode: PropTypes.string,
  }),
  loading: PropTypes.bool,
  error: PropTypes.string,
  onSelectEncounter: PropTypes.func.isRequired,
