...
export default function CardioPulmonaryClearance() {
  return (
    <div className="cardio-clearance-page">
      <div className="cardio-clearance-main">
        ...
        <div className="cardio-top-row">
          ...
          <span className="cardio-short-line" aria-hidden="true" />
        ...
        <div className="cardio-top-row">
          ...
          <span className="cardio-name-value">MATILOS , EUGENIA MAMBA</span>
        ...
        <div className="cardio-top-row">
          ...
          <span className="cardio-long-line" aria-hidden="true" />
        </div>
      ...
      <div className="cardio-footer">Generated by: TCP T. TCP on 2026-04-21 01:02 pm</div>
    </div>
  );
}