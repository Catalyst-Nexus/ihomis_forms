...
export default function MedicalAbstractDischargeSummary({ patientName, patientData }) {
	...
	const room           = patientData?.ward             || "";
	const attendingPhysician = patientData?.attendingPhysician || "";
	const briefHistory   = patientData?.briefHistory     || "";
	const physicalFindings = patientData?.physicalFindings || "";
	const impression     = patientData?.impression       || "";
